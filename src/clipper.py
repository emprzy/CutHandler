...
def group_and_clip(
    ...
    Args:
        ...
        xml: 
            Boolean to determine if the Adobe Premiere Pro sequence XML construction should take place, or
            clips should be saved as individual files with ffmpeg.
    """
        ...
        for row in group_df.itertuples(): 
            ...
            if xml: 
                ...
                if output_path.exists(): # TODO: for XML, we'll probably just want to add to the sequence, not fail 
                    ...
                    continue
                # TODO: run function for XML clipping
